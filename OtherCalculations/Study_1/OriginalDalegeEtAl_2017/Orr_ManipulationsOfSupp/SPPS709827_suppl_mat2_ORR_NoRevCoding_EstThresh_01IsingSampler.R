...
SampleMor <- IsingSampler(1000, SimInput$weiadj, 
                          c(1,SimInput$thresholds[2:10]),
                          responses = c(0L,1L))

SampleLed <- IsingSampler(1000, SimInput$weiadj, 
                          c(SimInput$thresholds[1],1,SimInput$thresholds[3:10]),
                          responses = c(0L,1L))

SampleCar <- IsingSampler(1000, SimInput$weiadj, 
                          c(SimInput$thresholds[1:2],1,SimInput$thresholds[4:10]),
                          responses = c(0L,1L))

SampleKno <- IsingSampler(1000, SimInput$weiadj, 
                          c(SimInput$thresholds[1:3],1,SimInput$thresholds[5:10]),
                        responses = c(0L,1L))

SampleInt <- IsingSampler(1000, SimInput$weiadj, 
                          c(SimInput$thresholds[1:4],1,SimInput$thresholds[6:10]),
                        responses = c(0L,1L))

SampleHop <- IsingSampler(1000, SimInput$weiadj, 
                          c(SimInput$thresholds[1:7],1,SimInput$thresholds[9:10]),
                        responses = c(0L,1L))

SampleAfr <- IsingSampler(1000, SimInput$weiadj, 
                          c(SimInput$thresholds[1:8],1,SimInput$thresholds[10]),
                        responses = c(0L,1L))

SamplePrd <- IsingSampler(1000, SimInput$weiadj, 
...
png("VertexPertDistributions2017a_DalegeStudy_NoRevCoding_EstThresh_01Ising.png",units="in", width=10, height=10, res=300)
par(mfrow = c(4,4))
hist(sumSampleNeg,xlab="Sum Score",main='Baseline',ylim=c(0,700))
text(5,500,f_wass_dist(table(sumSampleNeg),table(sumSampleNeg)))
text(5,200,mean(sumSampleNeg))
hist(sumSampleMor,xlab="Sum Score",main='Is Moral',ylim=c(0,700))
text(5,500,f_wass_dist(table(sumSampleNeg),table(sumSampleMor)))
text(5,200,mean(sumSampleMor))
hist(sumSampleLed,xlab="Sum Score",main='Strong Leadership',ylim=c(0,700))
text(5,500,f_wass_dist(table(sumSampleNeg),table(sumSampleLed)))
text(5,200,mean(sumSampleLed))
hist(sumSampleCar,xlab="Sum Score",main='Is Caring',ylim=c(0,700))
text(5,500,f_wass_dist(table(sumSampleNeg),table(sumSampleCar)))
text(5,200,mean(sumSampleCar))
hist(sumSampleKno,xlab="Sum Score",main='Is Knowledgeable',ylim=c(0,700))
text(5,500,f_wass_dist(table(sumSampleNeg),table(sumSampleKno)))
text(5,200,mean(sumSampleKno))
hist(sumSampleInt,xlab="Sum Score",main='Is Intelligent',ylim=c(0,700))
text(5,500,f_wass_dist(table(sumSampleNeg),table(sumSampleInt)))
text(5,200,mean(sumSampleInt))
hist(sumSampleHns,xlab="Sum Score",main='Is Honest',ylim=c(0,700))
text(5,500,f_wass_dist(table(sumSampleNeg),table(sumSampleHns)))
text(5,200,mean(sumSampleHns))
hist(sumSampleAng,xlab="Sum Score",main='Angry',ylim=c(0,700))
text(5,500,f_wass_dist(table(sumSampleNeg),table(sumSampleAng)))
text(5,200,mean(sumSampleAng))
hist(sumSampleHop,xlab="Sum Score",main='Hopeful',ylim=c(0,700))
text(5,500,f_wass_dist(table(sumSampleNeg),table(sumSampleHop)))
text(5,200,mean(sumSampleHop))
hist(sumSampleAfr,xlab="Sum Score",main='Afraid',ylim=c(0,700))
text(5,500,f_wass_dist(table(sumSampleNeg),table(sumSampleAfr)))
text(5,200,mean(sumSampleAfr))
hist(sumSamplePrd,xlab="Sum Score",main='Proud',ylim=c(0,700))
text(5,500,f_wass_dist(table(sumSampleNeg),table(sumSamplePrd)))
text(5,200,mean(sumSamplePrd))
dev.off()
