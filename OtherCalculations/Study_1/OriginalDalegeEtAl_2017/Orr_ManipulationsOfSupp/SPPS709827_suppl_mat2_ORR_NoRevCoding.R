...
SampleMor <- IsingSampler(1000, SimInput$graph, 
                          c(1,
                            rep(-.1,9)),#this sets the thesholds of the last four nodes to -.1
                          responses = c(-1L,1L))

SampleLed <- IsingSampler(1000, SimInput$graph, 
                          c(rep(-.1,1),#this sets the thesholds of the first five nodes to -.1
                            1,#this sets the threshold of the sixth node, which is the node Hns, to 1
                            rep(-.1,8)),#this sets the thesholds of the last four nodes to -.1
                          responses = c(-1L,1L))

SampleCar <- IsingSampler(1000, SimInput$graph, 
                        c(rep(-.1,2),#this sets the thesholds of the first five nodes to -.1
                          1,#this sets the threshold of the sixth node, which is the node Hns, to 1
                          rep(-.1,7)),#this sets the thesholds of the last four nodes to -.1
                        responses = c(-1L,1L))

SampleKno <- IsingSampler(1000, SimInput$graph, 
                        c(rep(-.1,3),#this sets the thesholds of the first five nodes to -.1
                          1,#this sets the threshold of the sixth node, which is the node Hns, to 1
                          rep(-.1,6)),#this sets the thesholds of the last four nodes to -.1
                        responses = c(-1L,1L))

SampleInt <- IsingSampler(1000, SimInput$graph, 
                        c(rep(-.1,4),#this sets the thesholds of the first five nodes to -.1
                          1,#this sets the threshold of the sixth node, which is the node Hns, to 1
                          rep(-.1,5)),#this sets the thesholds of the last four nodes to -.1
                        responses = c(-1L,1L))

SampleHop <- IsingSampler(1000, SimInput$graph, 
                        c(rep(-.1,7),#this sets the thesholds of the first five nodes to -.1
                          1,#this sets the threshold of the sixth node, which is the node Hns, to 1
                          rep(-.1,2)),#this sets the thesholds of the last four nodes to -.1
                        responses = c(-1L,1L))

SampleAfr <- IsingSampler(1000, SimInput$graph, 
                        c(rep(-.1,8),#this sets the thesholds of the first five nodes to -.1
                          1,#this sets the threshold of the sixth node, which is the node Hns, to 1
                          rep(-.1,1)),#this sets the thesholds of the last four nodes to -.1
                        responses = c(-1L,1L))

SamplePrd <- IsingSampler(1000, SimInput$graph, 
                        c(rep(-.1,9),
                          1),#this sets the thesholds of the last four nodes to -.1
                        responses = c(-1L,1L))
...
png("VertexPertDistributions2017a_DalegeStudy_NoRevCoding.png",units="in", width=10, height=10, res=300)
par(mfrow = c(4,4))
