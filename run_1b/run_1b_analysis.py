...
THIS IS ORDERED BY TWO THINGS, INNER X AXIS IS ORDERED BY INCREASTIN CENTRALITY
OUTER X AXIS IS ORDERD BY INCREASING BASE ATTRACTOR FREQUENCY
'''
df_sorted_bar_cols.T.plot.bar(stacked=False,legend=False,ylim=(0,24),width=0.90,colormap='gray')
plt.xlabel('Native Point-Attractor')
plt.ylabel('Weighted Hamming Distance')
#plt.legend(bbox_to_anchor=(0,1.02,1,0.2), loc="lower left",
#                mode="expand", borderaxespad=0, ncol=8,fontsize=10)
plt.savefig('Fig_WeightHam_All_Basis_Attractors_Bar.png',dpi=400,bbox_inches='tight')
...
plt.scatter(df.mean_centrality,df.wt_ham,color = 'black')
plt.savefig('Fig_WeightedCentralityByHam.png',dpi=400,bbox_inches='tight')
...
'''
NOTES ON INITIAL ANALYSIS (MAY NOT BE RELEVANT AT TIME OF SUBMISSION):
...
'''END WEIGHTED HAMMING #2 DEPRECIATED CODE'''
